...
// this tests a single selector to make sure the screenshot reconciliation bits work
describe("React Bank test", function () {
  ...
  it("logs in and runs the test steps", function () {
    ...
    // this incorrect spelling triggers css-suggest
    cy.get('header.home-healer').should('contain', 'Welcome to react-bank');
